...
prinz_eugen = rg.SimpleTurtle('classic')
prinz_eugen.pen = rg.Pen('Blue', 5)
prinz_eugen.speed = 1

prinz_eugen.left(90)
prinz_eugen.forward (200)
prinz_eugen.pen_up()
prinz_eugen.go_to(rg.Point(100,-40))
prinz_eugen.pen_down()
prinz_eugen.pen = rg.Pen('green', 5)
prinz_eugen.backward(150)
